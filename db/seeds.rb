...
d = Date.today
Event.create(title:'第5回英語勉強虫',opendate:d.to_s,opendate_memo:'19:00~23:00 (LO 22:30)',
...
# Swift 徹底入門
Event.create(title:'Swift徹底入門',opendate:(d+1.days).to_s,opendate_memo:'19:00~23:00',
  postal:'',address:'',address_embed:'',fee:1000,limit:0,desc_short:'',
